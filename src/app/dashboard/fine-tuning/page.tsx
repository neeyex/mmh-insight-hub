// src/app/dashboard/fine-tuning/page.tsx
...
// The page is now an 'async' server component, allowing it to fetch data.
export default async function FineTuningPage() {
  ...
  // We fetch the client's plan name from our database.
  ...
  const tallyFormUrl = getTallyFormUrl(clientProfile?.plan_name, user.id);
