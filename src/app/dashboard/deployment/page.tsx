...
// This is the critical new line. It tells Next.js to never cache this page.
    ...
    if (isDeployed) {
      ...
      return (
        ...
        <div className="text-center">
          ...
          <Link href="/dashboard#onboarding-section" className="mt-6 inline-flex items-center justify-center px-6 py-3 font-semibold text-primary-foreground bg-primary rounded-lg shadow-sm hover:bg-primary/90">
      ...
      return (
        ...
        <div className="text-center">
           <p className="text-sm text-gray-500">
            You can track our live progress on the <Link href="/dashboard/status" className="font-medium text-primary hover:underline">Agent Status</Link> page.
          </p>
        </div>
      );
    }
